...
const OneTrain = ({id, TrainId, TrainNumber, CarCount, DirectionNum, CircuitId, DestinationStationCode, LineCode, SecondsAtLocation, ServiceType }) => {
...
let cars = []
    ...
    return (
        <button className={colors[LineCode] + " collapsible"} 
        type="button"
        ...
        >
            ...
            <div
            className={!openTrainInfo ? "content" : "info"}
          >
